...
nohup ./${raxos_path} --name 0 --debugOn --debugLevel 4 >${output_path}0.log &
nohup ./${raxos_path} --name 1 --debugOn --debugLevel 4 >${output_path}1.log &
nohup ./${raxos_path} --name 2 --debugOn --debugLevel 4 >${output_path}2.log &
nohup ./${raxos_path} --name 3 --debugOn --debugLevel 4 >${output_path}3.log &
nohup ./${raxos_path} --name 4 --debugOn --debugLevel 4 >${output_path}4.log &
...
nohup ./${ctl_path} --name 5 --debugOn --debugLevel 4  --defaultReplica 0 --requestType request  --arrivalRate "${arrivalRate}">${output_path}5.log &
nohup ./${ctl_path} --name 6 --debugOn --debugLevel 4  --defaultReplica 1 --requestType request  --arrivalRate "${arrivalRate}">${output_path}6.log &
nohup ./${ctl_path} --name 7 --debugOn --debugLevel 4  --defaultReplica 2 --requestType request  --arrivalRate "${arrivalRate}">${output_path}7.log &
nohup ./${ctl_path} --name 8 --debugOn --debugLevel 4  --defaultReplica 3 --requestType request  --arrivalRate "${arrivalRate}">${output_path}8.log &
      ./${ctl_path} --name 9 --debugOn --debugLevel 4  --defaultReplica 4 --requestType request  --arrivalRate "${arrivalRate}">${output_path}9.log # last client is synced
