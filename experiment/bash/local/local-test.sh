...
nohup ./${raxos_path} --name 1 --debugOn --debugLevel 8 --batchSize 50 --pipelineLength 10 >${output_path}1.log &
nohup ./${raxos_path} --name 2 --debugOn --debugLevel 8 --batchSize 50 --pipelineLength 10 >${output_path}2.log &
nohup ./${raxos_path} --name 3 --debugOn --debugLevel 8 --batchSize 50 --pipelineLength 10 >${output_path}3.log &
nohup ./${raxos_path} --name 4 --debugOn --debugLevel 8 --batchSize 50 --pipelineLength 10 >${output_path}4.log &
nohup ./${raxos_path} --name 5 --debugOn --debugLevel 8 --batchSize 50 --pipelineLength 10 >${output_path}5.log &
