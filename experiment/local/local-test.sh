...
nohup ./${raxos_path} --name 1 --debugOn --debugLevel 16 --batchSize 50 --batchTime 100 --leaderTimeout 5000 --pipelineLength 1 --leaderMode 0 --epochSize 20 --serverMode  0 >${output_path}1.log &
nohup ./${raxos_path} --name 2 --debugOn --debugLevel 16 --batchSize 50 --batchTime 100 --leaderTimeout 5000 --pipelineLength 1 --leaderMode 0 --epochSize 20 --serverMode  0 >${output_path}2.log &
nohup ./${raxos_path} --name 3 --debugOn --debugLevel 16 --batchSize 50 --batchTime 100 --leaderTimeout 5000 --pipelineLength 1 --leaderMode 0 --epochSize 20 --serverMode  0 >${output_path}3.log &
nohup ./${raxos_path} --name 4 --debugOn --debugLevel 16 --batchSize 50 --batchTime 100 --leaderTimeout 5000 --pipelineLength 1 --leaderMode 0 --epochSize 20 --serverMode  0 >${output_path}4.log &
nohup ./${raxos_path} --name 5 --debugOn --debugLevel 16 --batchSize 50 --batchTime 100 --leaderTimeout 5000 --pipelineLength 1 --leaderMode 0 --epochSize 20 --serverMode  0 >${output_path}5.log &
...
nohup ./${ctl_path} --name 21 --debugOn --debugLevel 4 --requestType request --arrivalRate "${arrivalRate}"  --batchSize 50 --batchTime 100 >${output_path}21.log &
