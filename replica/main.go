...
func main() {
	...
	serverInstance := raxos.New(cfg, *name, *logFilePath, *batchSize, *batchTime, *leaderTimeout, *pipelineLength, *benchmark, *debugOn, *debugLevel, *leaderMode, *exec) // create a new server instance
